...
export const uploadImage = async (originalBlob: Blob, w: ConnectedWallet, sendTransaction: any, category?: string) => {
	try {
		// Initialize WebIrys
...
export const fetchImages = async ({ category }: { category: CATEGORIES | null }): Promise<Item[]> => {
